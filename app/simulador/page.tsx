...
import { Search, Plus, Calendar as CalendarIcon, Check, ChevronsUpDown, X } from "lucide-react";
...
const formSchema = z.object({
  ...
  pesquisasPreco: z.array(z.string()).min(1, "Pelo menos uma pesquisa de preço é obrigatória"),
...
const mockData = {
  ...
  pesquisasPreco: ["Pesquisa Mensal", "Pesquisa Semanal", "Pesquisa Concorrentes"],
                  ...
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-full flex-1">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Nome da simulação <span className="text-red-500">*</span></FormLabel>
                            <FormControl>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Pesquisas de preço <span className="text-red-500">*</span></FormLabel>
                            <FormControl>
                              <MultiSelect
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>Período <span className="text-red-500">*</span></FormLabel>
                            <FormControl>
                              <DateRangePicker
                                value={field.value}
                                onChange={field.onChange}
